...
One of the struggle regions for theoritical telluric modeling efforts are O2 bands.  Here we show the 28th order for HR4829 (same star as above), which has a significant O2 band in the middle of the wavelength region.  The fit looks very accurate compared to other previous efforts (e.g., Gullikson et al. 2014, Ulmer-Moll et al. 2019).
